      ...
      async function starteSchachprogramm() {
        ...
        function generellMoeglich(
          ...
          if (anwesendeFigur === "bauer_w") {
            ...
            let zugweiteBuchstabe = Math.abs(
        ...
        function explizitMoeglich(felderVerzeichnis, linie, zu, amZug, von) {
          ...
          if (felderVerzeichnis[von][2].slice(0, -2) === "könig") {
            let zugweiteBuchstabe =
              felderVerzeichnis[von][1] - felderVerzeichnis[zu][1];
            if (
              [2, -2].includes(zugweiteBuchstabe) &&
              felderVerzeichnis[zu][2]
            ) {
              zutreffend = false;
            }
          }
        ...
        function explizitMoeglichGegner(
          felderVerzeichnis,
          linie,
          zu,
          amZug,
              ...
              if (möglich) {
                ...
                if (möglich) {
                  ...
                  if (möglich) {
                    ...
                    if (möglich) {
                      answer = await ask(
                        "Das geht. Schreibe 'Ja' um den Zug auszuführen."
                      );
